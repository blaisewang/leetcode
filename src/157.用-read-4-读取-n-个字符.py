...
#
# https://leetcode-cn.com/problems/read-n-characters-given-read4/description/
#
# algorithms
# Easy (52.34%)
# Likes:    30
...
# 输入： file = "abc", n = 4
# 输出： 3
# 解释： 当执行你的 read 方法后，buf 需要包含 "abc"。 文件一共 3 个字符，因此返回 3。 注意 "abc" 是文件的内容，不是 buf
# 的内容，buf 是你需要写入结果的目标缓存区。 
# 
# 示例 2：
# 
# 输入： file = "abcde", n = 5
