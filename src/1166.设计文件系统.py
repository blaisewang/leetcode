...
# [1166] 设计文件系统
#
# https://leetcode-cn.com/problems/design-file-system/description/
#
# algorithms
# Medium (48.66%)
# Likes:    10
...
# 
# 
# create(path, value): 创建一个新的路径，并尽可能将值 value 与路径 path 关联，然后返回
# True。如果路径已经存在或者路径的父路径不存在，则返回 False。
...
class FileSystem:
    ...
    def createPath(self, path: str, value: int) -> bool:
        ...
        if index != 0 and path[:index] not in self.d:
            return False
