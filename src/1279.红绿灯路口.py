...
# [1279] 红绿灯路口
#
# https://leetcode-cn.com/problems/traffic-light-controlled-intersection/description/
#
# concurrency
# Easy (61.56%)
# Likes:    4
...
# 
# 
# 输入: cars = [1,3,5,2,4], directions = [2,1,2,4,3], arrivalTimes =
# [10,20,30,40,50]
# 输出: [
...
# 
# 
# 输入: cars = [1,2,3,4,5], directions = [2,4,3,3,1], arrivalTimes =
# [10,20,30,40,40]
# 输出: [
# "Car 1 Has Passed Road A In Direction 2",    // A 路上的红绿灯为绿色，1 号车可通过路口。
# "Traffic Light On Road B Is Green",          // 2 号车在 B 路请求绿灯。
...
# "Traffic Light On Road B Is Green",          // 4 号车在 B 路请求绿灯。4 号车在路口等灯，直到 5
# 号车通过路口，B 路的绿灯亮起。
