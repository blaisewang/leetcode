...
# [751] IP 到 CIDR
#
# https://leetcode-cn.com/problems/ip-to-cidr/description/
#
# algorithms
# Easy (54.57%)
# Likes:    17
...
# 
# CIDR 块是包含 IP 的字符串，后接斜杠和固定长度。例如：“123.45.67.89/20”。固定长度 “20”
# 表示在特定的范围中公共前缀位的长度。
# 
# 示例 1：
# 
...
class Solution:
    def ipToCIDR(self, ip: str, n: int) -> List[str]:
        ...
        res = []
        while n:
            mask = min(32, max(33 - (s & -s).bit_length(), 33 - n.bit_length()))
            res.append(int_to_ip(s) + "/" + str(mask))
            s += 1 << (32 - mask)
            n -= 1 << (32 - mask)
