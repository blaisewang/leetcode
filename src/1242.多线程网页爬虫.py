...
# [1242] 多线程网页爬虫
#
# https://leetcode-cn.com/problems/web-crawler-multithreaded/description/
#
# concurrency
# Medium (40.49%)
# Likes:    18
...
#
# 给你一个初始地址 startUrl 和一个 HTML 解析器接口 HtmlParser，请你实现一个 多线程的网页爬虫，用于获取与 startUrl 有
# 相同主机名 的所有链接。 
# 
# 以 任意 顺序返回爬虫获取的路径。
# 
...
# 
# 
# 如上图所示，主机名是 example.org 。简单起见，你可以假设所有链接都采用 http 协议，并且没有指定 端口号。举个例子，链接
# http://leetcode.com/problems 和链接 http://leetcode.com/contest 属于同一个 主机名， 而
# http://example.org/test 与 http://example.com/abc 并不属于同一个 主机名。
# 
# HtmlParser 的接口定义如下：
# 
# 
...
# 主机名的长度必须为 1 到 63 个字符（包括点 . 在内），只能包含从 “a” 到 “z” 的 ASCII 字母和 “0” 到 “9”
# 的数字，以及中划线 “-”。
# 主机名开头和结尾不能是中划线 “-”。
# 
